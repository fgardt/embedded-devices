use paste::paste;
use uom::si::f64::{
    ElectricCharge, ElectricCurrent, ElectricPotential, ElectricalResistance, Energy, Frequency, Illuminance,
    MassConcentration, Power, Pressure, Ratio, ThermodynamicTemperature, Velocity,
};
...
define_sensor_measurement!(GasResistance, ElectricalResistance, "gas resistance");
